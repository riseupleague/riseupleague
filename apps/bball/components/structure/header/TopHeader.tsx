	...
	return (
		...
		<div className="container mx-auto grid grid-cols-2 py-4 lg:py-4 font-barlow uppercase bg-background: #04080F border-b border-gray-200;">
			<div className="flex items-center justify-center lg:justify-start">
					<Link href="https://riseupleague.com" className="hidden hover:opacity-80 lg:inline-block hover:text-primary text-l transition-all mr-8 focus:text-primary focus:underline active:text-red-500 active:underline">RISEUP.COM</Link>
					<Link href="https://bball.riseupleague.com" className="hidden hover:opacity-80 lg:inline-block hover:text-primary text-l transition-all mr-8 focus:text-primary focus:underline active:text-red-500 active:underline">BASKETBALL</Link>
					<Link href="https://vball.riseupleague.com" className="hidden hover:opacity-80 lg:inline-block hover:text-primary text-l transition-all focus:text-primary focus:underline active:text-red-500 active:underline">VOLLEYBALL</Link>
			</div>
