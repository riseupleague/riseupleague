				...
				<>
					...
					<div className="mt-10 flex flex-col gap-10 ">
						<Accordion type="single" collapsible className="w-full">
							<AccordionItem value="item-1" className=" mb-10  border-b-0">
								<AccordionTrigger className="rounded-md bg-neutral-700 px-[16px] py-[26px]">
									Filipino Beginner
								</AccordionTrigger>
								<AccordionContent>
									<div>
										<div className="mt-5 rounded-md bg-neutral-700">
											...
											<div className="bg-register-card col-span-1 flex flex-col gap-7 p-4">
												<div className="flex  gap-2  md:flex-row">
													...
													<p className="text-sm">
														813 Sheridan College Dr, Brampton, ON L6Y 5H9{" "}
													</p>
												</div>
												<div className="flex  gap-2 md:flex-row">
													<svg
													...
													<p className="text-sm">1:30 - 5:30 PM </p>
												</div>
												<div className="flex  gap-2 md:flex-row">
													<svg
														xmlns="http://www.w3.org/2000/svg"
											...
											<div className="col-span-3  p-4">
												<p className="text-sm">
													Those who are looking to play organized ball for
													health and active living then this level is for you.{" "}
												</p>
										...
										<div className="mt-10 flex justify-end">
											<Button onClick={() => onCreateTeam(true)}>
												{" "}
												Continue
											</Button>
										</div>
							...
							<AccordionItem value="item-2" className=" mb-10  border-b-0">
								<AccordionTrigger className="rounded-md bg-neutral-700 px-[16px] py-[26px]">
									...
									<div>
										<div className="mt-5 rounded-md bg-neutral-700">
											...
											<div className="col-span-3  p-4">
												...
												<div className="mb-5 flex justify-end ">
													<div className="flex-1 border-r border-neutral-600  p-4">
														<span className="bg-secondary  mb-2 inline-block w-fit rounded-md px-2 py-1  uppercase text-neutral-400">
															Other Leagues
														</span>
														<div className="relative flex items-center gap-2">
							...
							<AccordionItem value="item-3" className=" mb-10  border-b-0">
								<AccordionTrigger className="rounded-md bg-neutral-700 px-[16px] py-[26px]">
									Filipino Great
								</AccordionTrigger>
								<AccordionContent>
