...
export default function PrimaryHeader(): React.JSX.Element {
	...
	const headerOptions = [
		{
			...
			icon: (
				<svg
					...
					fill="none"
				>
					<g clip-path="url(#clip0_980_1620)">
						<path
	...
	return (
		<nav>
			<div className="container mx-auto hidden items-center justify-between py-8 md:flex">
				<div>
			...
			<ul className="fixed bottom-0 left-0 z-50 flex  w-full items-center justify-evenly border border-neutral-600 bg-neutral-700 px-[15px] pb-[25px] pt-[15px] backdrop-blur-md md:hidden">
				{headerOptions.map((option, index) => {
					let isActive;
										...
										<ul className="mt-5 flex flex-col gap-6">
											<li>
												<Link
													...
													className="flex items-center gap-3"
												>
													<span className="font-barlow text-[20px] uppercase tracking-tighter">
														About Us
													</span>
												</Link>
											</li>
