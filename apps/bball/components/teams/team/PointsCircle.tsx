...
const PointsCircle = ({ team, pointsAverage }): JSX.Element => {
	const canvasRef = useRef(null);

	const data = [
		{
			label: "Threes Made",
			points: team.averageStats?.threesMade,
			color: "#FAFAFA",
			value: 3, // point value for this category is 3
		},
		{
			label: "Twos Made",
			points: team.averageStats?.twosMade,
			color: "#E16B3D",
			value: 2, // point value for this category is 2
		},
		{
			label: "Free Throws Made",
			points: team.averageStats?.freeThrowsMade,
			color: "#6366F1",
