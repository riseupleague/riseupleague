				...
				<div className="grid grid-cols-3">
					...
					>
						<TeamLogo
							...
							circleWidth={4}
						/>
						<span className="font-barlow text-center text-sm transition hover:opacity-80 lg:text-lg">
					...
					<div className="font-barlow  flex flex-col justify-center py-4 text-center uppercase">
						<div className="mb-[35px] flex justify-center">
							<p className="w-fit rounded bg-neutral-600 px-4 py-1 text-center text-[10px] md:text-xs">
					...
					<div className="flex flex-col items-center gap-[10px] p-4">
						...
						<Link
							...
							className="font-barlow text-center text-sm transition hover:opacity-80 lg:text-lg"
						>
