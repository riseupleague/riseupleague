...
export default function SecondaryHeaderSkeleton() {
	...
	return (
		<div className="flex items-center overflow-x-auto overflow-y-hidden xl:overflow-x-hidden">
			<div className="flex h-[140px] items-center rounded-sm border-y border-neutral-600">
